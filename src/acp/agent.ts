...
export class PiAcpAgent implements ACPAgent {
  ...
  async newSession(params: NewSessionRequest) {
    ...
    setTimeout(() => {
      void (async () => {
        // Publish usage after the client knows the sessionId (clients ignore notifications
        // for unknown sessions), so context size is correct before the first prompt.
